    ...
    public static void main(String[] args) {
        System.out.println("===\tOrdem aleatória\t===");
            Map<String, Livro> meusLivros = new HashMap<>(){{
                put(" Hawking, Stephen", new Livro("Uma Breve Historia do Tempo", 300));
                put(" Duhigg, Charles", new Livro("O poder do Hábito", 408));
                put(" Harari, Yuval Noah", new Livro("21 Liçoes Para o Século 21", 200));
            }};
...
class ComparatorNome implements Comparator<Map.Entry<String, Livro>>{
    ...
    @Override
    public int compare(Map.Entry<String, Livro> l1, Map.Entry<String, Livro> l2) { // Pegar o valor e compara com o nome
